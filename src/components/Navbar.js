...
export default function Navbar(props) {
  return (
      <nav className={` navbar navbar-expand-lg  navbar ${props.mode } bg-${props.mode}`} style={{backgroundColor:"gray"}}>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0 fs-4" >
          <li className="nav-item">
            <Link className="nav-link mx-4" to="/">{props.home}</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link mx-4" to="/about">{props.about}</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link  mx-4" to="/contact">{props.contact}</Link>
          </li>
